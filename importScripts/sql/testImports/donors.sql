...
(SELECT SourceID FROM SourcesExport WHERE SourceName IS NOT NULL LIMIT 5)
 ...
 UNION(SELECT SourceID FROM SourcesExport WHERE SourceName IN (
    '>',
    'A N MARCHANT',
    'MARCHANT A.N.',
    'ALBANY HIST SOC',
...
FROM
    SourcesExport
WHERE
    SourceID IN(1,1880,1740,1293,1601,4,5,8,9,10,489,511,550,565,578,6,13,494,1223,1310,1333,1686,2,7,12,29,123,141,151,1395,1649,1650,1662,11,1363,1351,1554,1553,344)
;
