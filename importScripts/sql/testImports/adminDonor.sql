...
UNION(SELECT PrimaryKey_Object_Table FROM ObjectsExport WHERE SourceName IN (
    '>',
    'A N MARCHANT',
    'MARCHANT A.N.',
    'ALBANY HIST SOC',
...
FROM
	ObjectsExport
WHERE
	PrimaryKey_Object_Table IN(29076,29100,29,30,1621,1622,47,48,1537,1570,26530,28676,4462,7203,28008,4239,27545,16216,3677,14844,679,750,3672,3837,3,6,10,24,1723,1726,2823,2830,2,3,51,52,8,23,11956,11960,8373,19066,1624,1646,404,2636,2759,2760,2762,2763,2764,2765,2766,2767,2768,15283,15689,15690,15691,15692,15693,15694,15695,15696,15697,15698,17040,17041,17042,17043,17044,17045,17046,23782)
;
